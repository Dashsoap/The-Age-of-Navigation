...
uint256 constant ID = uint256(keccak256("system.BuffEffectKeepResourceOnDeathExecute"));

contract BuffEffectKeepResourceOnDeathExecuteSystem is BuffEffectSystem {
    constructor(
        IWorld _world,
        address _components
