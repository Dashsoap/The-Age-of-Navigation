...
uint256 constant ID = uint256(keccak256("system.GuildChargeLinearTreasure"));
...
contract GuildChargeLinearTreasureSystem is System {
    constructor(
        IWorld _world,
        address _components
    ...
    function executeTyped(
        ...
        require(chargeTreasureInfo.distance < treasure.range * guildConfig.basicRangeFactor / 1000, "distance invalid");
        TreasureLinearChargingComponent(
            ...
            area: uint32(treasureEffect.area * uint32(guildConfig.basicAreaFactor) / 1000)
        }));
