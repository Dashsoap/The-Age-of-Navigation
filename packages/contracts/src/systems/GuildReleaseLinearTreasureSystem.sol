...
// components: ["TreasureLinearChargingComponent", "TreasureTimerComponent", "ChargingComponent", "Treasurev2Component", "PlayerBelongingComponent", "TreasureEffectv2Component"]
...
uint256 constant ID = uint256(keccak256("system.GuildReleaseLinearTreasure"));
...
contract GuildReleaseLinearTreasureSystem is System {
    constructor(
        IWorld _world,
        address _components
    ...
    function executeTyped(
        ...
        //TODO: verify path in range & area in area
